...
const (
	Executor_PushJob_FullMethodName = "/proto.Executor/PushJob"
)
...
func (c *executorClient) PushJob(ctx context.Context, in *PushJobRequest, opts ...grpc.CallOption) (*PushJobResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PushJobResponse)
	err := c.cc.Invoke(ctx, Executor_PushJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedExecutorServer) PushJob(context.Context, *PushJobRequest) (*PushJobResponse, error) {
...
func _Executor_PushJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PushJobRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExecutorServer).PushJob(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Executor_PushJob_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExecutorServer).PushJob(ctx, req.(*PushJobRequest))
	}
...
var Executor_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PushJob",
			Handler:    _Executor_PushJob_Handler,
		},
	},
